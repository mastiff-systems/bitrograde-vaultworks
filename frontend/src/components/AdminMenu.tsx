  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative flex-shrink-0 p-1.5 rounded text-content-muted hover:text-content-primary hover:bg-surface-4 transition-colors focus-visible:ring-2 focus-visible:ring-accent/50 focus:outline-none before:content-[''] before:absolute before:-inset-2"
      >
