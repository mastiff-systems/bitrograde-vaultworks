...
/** Icon-only header theme toggle — replaces the Collections icon (MAS-778). */
function ThemeToggleButton() {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="relative flex-shrink-0 p-1.5 rounded transition-colors focus-visible:ring-2 focus-visible:ring-accent/50 focus:outline-none before:content-[''] before:absolute before:-inset-2 text-content-muted hover:text-content-primary hover:bg-surface-4"
    >
