  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        onClick={() => setOpen((v) => !v)}
        title="Notifications"
        className="relative flex-shrink-0 p-1.5 rounded text-content-muted hover:text-content-primary hover:bg-surface-4 transition-colors before:content-[''] before:absolute before:-inset-2"
      >
      ...
      {open && (
        <div className="absolute top-full right-0 mt-2 w-80 rounded-xl border border-border bg-surface-1 shadow-xl z-50">
          {/* Header */}
